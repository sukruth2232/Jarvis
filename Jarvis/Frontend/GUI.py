...
from PyQt5.QtGui import (QIcon, QPainter, QMovie, QColor, QTextFormat, QTextCharFormat, 
...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "when", "why", "which", "can You", "how's"]
